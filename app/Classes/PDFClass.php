...

{
...

    {
        ...
        $this->Cell(0,3,'ASL Roma 2 - P.IVA 13665151000 Sede Legale Via Maria Brighenti, 23 Edificio - B 00159 Roma',0,0,'L');

        $this->Cell(0,3,'Pag. '.$this->PageNo().'/{nb}'.' Data: '.$now,0,0,'R');
