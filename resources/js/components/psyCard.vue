                                        ...
                                        <div class="row" style="margin-top:20px;">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="item form-group" >
                                                    ...
                                                    <span class="col-md-12 col-sm-12">
                                                        <span>Zero</span>
                                                        <input type="radio"  @click="calculateSum" name="social_support" value="0" v-model="psyriskFactor.stressAndCoping"/>
                                                        <span>Uno</span>
                                                        <input type="radio"  @click="calculateSum" name="social_support" value="1" v-model="psyriskFactor.stressAndCoping"/>
                                                        <span>Due</span> 
                                                        <input type="radio"  @click="calculateSum" name="social_support" value="2" v-model="psyriskFactor.stressAndCoping"/> 
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="item form-group" >
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <textarea name="psy_suicide_note" cols="25" rows="5" v-model="psyCardTsc.psySuicideNote"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="margin-top:20px;">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="item form-group" style="padding-top: 2rem;">
                                                        ...
                                                        <span class="col-md-12 col-sm-12">
                                                            <span>Alto</span>
                                                            <input type="radio" name="imminent_risk_of_suicide" value="alto" v-model="psyCardTsc.imminentRiskOfSuicide"/>
                                                            <span>Medio</span>
                                                            <input type="radio" name="imminent_risk_of_suicide" value="medio" v-model="psyCardTsc.imminentRiskOfSuicide"/>
                                                            <span>Basso</span> 
                                                            <input type="radio" name="imminent_risk_of_suicide" value="basso" v-model="psyCardTsc.imminentRiskOfSuicide"/> 
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="row" style="margin-top:20px;">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="item form-group" >
                                                        ...
                                                        <span class="col-md-12 col-sm-12">
                                                            <span>Si</span>
                                                            <input type="radio" name="monitoring_recommendation" value="1" v-model="psyCardTsc.monitoringRecommendation"/>
                                                            <span>No</span>
                                                            <input type="radio" name="monitoring_recommendation" value="0" v-model="psyCardTsc.monitoringRecommendation"/>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-top:20px;">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="item form-group" >
                                                        ...
                                                        <span class="col-md-12 col-sm-12">
                                                            <span>24 ore</span>
                                                            <input type="radio" name="frequency" value="24 ore" v-model="psyCardTsc.frequency"/>
                                                            <span>15 min.</span>
                                                            <input type="radio" name="frequency" value="15 min" v-model="psyCardTsc.frequency"/>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-top:20px;">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="item form-group" >
                                                        ...
                                                        <span class="col-md-12 col-sm-12">
                                                            <span>Si</span>
                                                            <input type="radio" name="referral_mental_health_service" value="1" v-model="psyCardTsc.referralMentalHealthService"/>
                                                            <span>No</span>
                                                            <input type="radio" name="referral_mental_health_service" value="0" v-model="psyCardTsc.referralMentalHealthService"/>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top:20px;">
                                            <div class="col-md-12 col-sm-12">
                                                <div class="item form-group" >
                                                    ...
                                                    <span class="col-md-12 col-sm-12">
                                                        <textarea name="comment" cols="25" rows="5" v-model="psyCardTsc.comment"></textarea>
                                                    </span>
                                                </div>
                                            </div>
                                        </div> 
            ...
            addPsyCard(panel){
                ...
                if(_panel=='sa'){
                    ...
                    if(!this.isObjEmpty(this.psyCardTsc)){
                        let _psyCard=JSON.stringify(this.psyCardTsc);
